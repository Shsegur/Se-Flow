...
export default function App() {
  ...
  }, [processedInstallments, cobrosFilter, cobrosReminderScope, searchTerm, clients]);
  ...
  const pendingPaymentClients = useMemo(() => {
    ...
    return Object.values(byClient)
      .map((entry) => ({ ...entry, client: clients.find(c => c.id === entry.clientId) }))
      .filter(entry => entry.client && entry.client.status !== 'baja')
      .sort((a, b) => b.maxDaysOverdue - a.maxDaysOverdue);
  }, [clients, policies, processedInstallments]);
  ...
  }, [clients, searchTerm, policies, clientsScope, pendingClientIds]);
  ...
  const installmentReminderGroups = useMemo(() => {
    ...
    return groups;
  }, [processedInstallments, clients, policiesById, agencySettings.installmentNotifyMode]);
  ...
  const policyReminderGroups = useMemo(() => {
    ...
    return groups;
  }, [policies, clients, agencySettings.policyNotifyMode]);
